...
{
public:
    ProjectLocationsModel(PNDatabaseObjects* t_dbo);
    PNSqlQueryModel* createExportVersion() override { return dynamic_cast<PNSqlQueryModel*>(new ProjectLocationsModel(getDBOs())); }

...
**To open a project:**
1. From the [Project List Page](<Project List Page>), double-click the project row number.
...
| Status Report Period | The planned status report period for a project: **None**, **Weekly**, **Bi-Weekly**, or **Monthly**. Once a project is complete and not closed, the None status will turn off indicators in the [Project List Page](<ProjectListPage>). |
...
| **Column** | **Description** |
| --- | --- |
| Team Member | The person selected from values found in the [People List Panel](<PeopleListPage>). |
| Role | The role is an open text field. If a Role has been specified in the [People List Panel](<PeopleListPage>), it will auto populate with a value you can change. |
...
2. Select **Delete Item**, From the **Edit** menu.
3. Click **Yes** to confirm the deletion. Note: You may not be able to delete the team member if it is associated with other project information. In this case clicking, **Yes** opens the Search Page. The [File Menu](<FileMenu>) topic explains how the Search Page works.
...
2. Select **Delete Item**, From the **Edit** menu.
3. Click **Yes** to confirm the deletion. Note: You may not be able to delete the note if it is associated with other project information. In this case clicking, **Yes** opens the Search Page. The [File Menu](<FileMenu>) topic explains how the Search Page works.

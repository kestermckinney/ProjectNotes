...
void db_CreateAllViews()
{
    ...
    QString search_view = R"(
        CREATE VIEW database_search AS select 'Client' as datatype, 'Client Name' as dataname, client_name as datadescription, id as dataid, '0' as internal_item, id, 'Active' as project_status, '' as project_number, '' as project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, id as datakey from clients
        -- list all the people data
        union all
        select 'People' as datatype, 'Person Name' as dataname, name as datadescription, id as dataid, '0' as internal_item, client_id, 'Active' as project_status, '' as project_number, '' as project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, id as datakey from people
        union all
        select 'People' as datatype, 'Person Email' as dataname, email as datadescription, id as dataid, '0' as internal_item, client_id, 'Active' as project_status, '' as project_number, '' as project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, '' as datakey from people
        union all
        select 'People' as datatype, 'Person Office Phone' as dataname, office_phone as datadescription, id as dataid, '0' as internal_item, client_id, 'Active' as project_status, '' as project_number, '' as project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, '' as datakey from people
        union all
        select 'People' as datatype, 'Person Cell Phone' as dataname, cell_phone as datadescription, id as dataid, '0' as internal_item, client_id, 'Active' as project_status, '' as project_number, '' as project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, '' as datakey from people
        union all
        select 'People' as datatype, 'Person Client Name' as dataname, clients.client_name as datadescription, people.id as dataid, '0' as internal_item, people.client_id, 'Active' as project_status, '' as project_number, '' as project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, people.client_id as fk_id, people.client_id as datakey from people join clients on clients.id=people.client_id
        -- list all project data
        union all
        select 'Project' as datatype, 'Project Number' as dataname, project_number as datadescription, id as dataid, '0' as internal_item, client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, id as datakey from projects
        union all
        select 'Project' as datatype, 'Project Name' as dataname, project_name as datadescription, id as dataid, '0' as internal_item, client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, id as datakey from projects
        union all
        select 'Project' as datatype, 'Last Status Date' as dataname, strftime('%m/%d/%Y', datetime(last_status_date, 'unixepoch')) as datadescription, id as dataid, '0' as internal_item, client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, '' as datakey  from projects
        union all
        ...
        union all
        select 'Project' as datatype, 'Primary Contact' as dataname, people.name as datadescription, projects.id as dataid, '0' as internal_item, projects.client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, people.id as fk_id, primary_contact as datakey  from projects join people on primary_contact=people.id
        union all
        select 'Project' as datatype, 'Invoicing Period' as dataname, invoicing_period as datadescription, id as dataid, '0' as internal_item, client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, '' as datakey  from projects
        union all
        select 'Project' as datatype, 'Client' as dataname, clients.client_name as datadescription, projects.id as dataid, '0' as internal_item, projects.client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, projects.client_id as fk_id, projects.client_id as datakey  from projects join clients on clients.id=projects.client_id
        union all
        select 'Project' as datatype, 'Project Status' as dataname, project_status as datadescription, id as dataid, '0' as internal_item, client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, '' as fk_id, '' as datakey from projects
        ...
        union all
        select 'Project Team' as datatype, 'Member Name' as dataname, people.name as datadescription, project_people.id as dataid, '0' as internal_item, projects.client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, projects.id as fk_id, people.id as datakey from project_people join people on project_people.people_id=people.id join projects on project_people.project_id=projects.id
        union all
        select 'Project Team' as datatype, 'Role' as dataname, role as datadescription, project_people.id as dataid, '0' as internal_item, projects.client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, projects.id as fk_id, '' as datakey from project_people join projects on project_people.project_id=projects.id
        -- list all status report items
        union all
        select 'Status Report Item' as datatype, 'Project Number' as dataname, project_number as datadescription, status_report_items.id as dataid, '0' as internal_item, projects.client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, projects.id as fk_id, projects.id as datakey from status_report_items left join projects on status_report_items.project_id=projects.id
        union all
        select 'Status Report Item' as datatype, 'Category' as dataname, task_category as datadescription, status_report_items.id as dataid, '0' as internal_item, projects.client_id, project_status, project_number, project_name, '' as item_number, '' as item_name, '' as note_date, '' as note_title, projects.id as fk_id, '' as datakey from status_report_items left join projects on status_report_items.project_id=projects.id
        union all

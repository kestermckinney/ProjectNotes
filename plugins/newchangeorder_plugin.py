...
def setup_default_new_change_order_settings():
    pnc_tmp = ProjectNotesCommon()
    settings_pluginname = "New Change Order"
...
if (platform.system() == 'Windows'):
    ...
    setup_default_new_change_order_settings()
    ...
    def menu_change_order(xmlstr, parameter):
        ...
        if not pnc.folder_exists(projectfile):
            ...
            print(msg)
            QMessageBox.critical(QApplication.activeWindow(),"Folder Does Not Exist")
            return ""

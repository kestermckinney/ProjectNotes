...
def setup_default_new_ms_project_settings():
    pnc_tmp = ProjectNotesCommon()
    settings_pluginname = "New MS Project"
    if pnc_tmp.get_plugin_setting("ExportSubFolder", settings_pluginname) is None:
        pnc_tmp.set_plugin_setting("ExportSubFolder", settings_pluginname, "Project Management/Schedule")

# this plugin is only supported on windows
if (platform.system() == 'Windows'):
    setup_default_new_ms_project_settings()
    #

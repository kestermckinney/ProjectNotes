...
if (platform.system() == 'Windows'):
    ...
    def event_data_rightclick(xmlstr):
        ...
        if project:
            ...
            if not projectrow.isNull():
                message.Subject = pnc.get_column_value(projectrow, "project_number") + " " + pnc.get_column_value(projectrow, "project_name") + " - Internal Lessons Learned"
    ...
    def main_process_meeting( xmlval ):
        ...
        if not projectrow.isNull():
            message.Subject = pnc.get_column_value(projectrow, "project_id") + " " + pnc.get_column_value(projectrow, "project_id_name") + " - Internal Lessons Learned"

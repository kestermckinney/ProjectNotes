...
if (platform.system() == 'Windows'):
    ...
    pluginmenus.append({"menutitle" : "Export Meeting Notes", "function" : "menuExportMeetingNotes", "tablefilter" : "projects/project_notes/meeting_attendees/item_tracker/project_locations", "submenu" : "Utilities", "dataexport" : "projects"})

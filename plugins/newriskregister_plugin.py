...
def setup_default_new_risk_register_settings():
    pnc_tmp = ProjectNotesCommon()
    settings_pluginname = "New Risk Register"
    if pnc_tmp.get_plugin_setting("ExportSubFolder", settings_pluginname) is None:
        pnc_tmp.set_plugin_setting("ExportSubFolder", settings_pluginname, "Project Management/Risk Management")

# this plugin is only supported on windows
if (platform.system() == 'Windows'):
    setup_default_new_risk_register_settings()

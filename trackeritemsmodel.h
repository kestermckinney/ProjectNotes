...
{
public:
    TrackerItemsModel(PNDatabaseObjects* t_dbo);
    PNSqlQueryModel* createExportVersion() override { return dynamic_cast<PNSqlQueryModel*>(new TrackerItemsModel(getDBOs())); }

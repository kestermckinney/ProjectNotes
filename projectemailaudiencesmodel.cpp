...
ProjectEmailAudiencesModel::ProjectEmailAudiencesModel(DatabaseObjects *dbo) : SqlQueryModel(dbo)
{
    ...
    setBaseSql("SELECT id,project_id,workflow,audience_name,people_source,company_filter,selected_company_ids_json,selected_person_ids_json,recipient_distribution_json,is_default,settings_version FROM project_email_audiences");

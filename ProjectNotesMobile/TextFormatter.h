...
public:
    ...
    // An invalid/transparent foreground color clears the explicit color so the
    // document inherits the editor/theme color again.
    ...
    Q_INVOKABLE bool    hasFontHighlightAt(QQuickTextDocument* doc, int pos) const;

...
{
public:
    TrackerItemCommentsModel(PNDatabaseObjects* t_dbo, bool t_gui = true);
    PNSqlQueryModel* createExportVersion() override { return dynamic_cast<PNSqlQueryModel*>(new TrackerItemCommentsModel(getDBOs(), false)); };
